<h1 align="center">
  Somando-Tempos-com-Metodo-Reduce
</h1>
...
Somando tempo de vídeos com reduce, usando javaScript.
...
```bash
  ❯ git clone https://github.com/Talison-Miguel/Somando-Tempos-com-Metodo-Reduce.git
```
